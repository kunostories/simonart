...
<div class="container">
        ...
        <div class="col-md-12" id="carousel-bounding-box">
          <div class="carousel slide" id="testCarousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="item" data-slide-number="12"><img alt=
              "" class="img-responsive" src="1michaelanthonysimon33.jpeg"><div class="carousel-caption"><span class="image-title">Red, Yellow, and Blue in Excited States (View 3, Version1)</span>, Dimensions Variable, Lacquer on Nephila Clavata Spider Web. 2011</div></div>

              <div class="item" data-slide-number="13"><img alt=
              "" class="img-responsive" src="1michaelanthonysimon34.jpeg"><div class="carousel-caption"><span class="image-title">Excited Yellow Fading to Black</span>, Dimensions Variable, Lacquer on Nephila Clavata Spider Web. 2011</div></div>

              <div class="item" data-slide-number="14"><img alt=
    ...
    <div class="col-md-12 hidden-xs" id="slider-thumbs">
      ...
      <ul class="list-inline">
        <li>
          <a class="selected" id="carousel-selector-00"><img class=
          "img-responsive" src="thumbs/michaelanthonysimon161.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-01"><img class="img-responsive" src=
          "thumbs/michaelanthonysimon165.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-02"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon23.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-03"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon24.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-04"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon25.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-05"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon26.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-06"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon27.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-07"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon28.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-08"><img class="img-responsive" src="thumbs/1michaelanthonysimon29.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-09"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon30.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-10"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon31.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-11"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon32.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-12"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon33.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-13"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon34.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-14"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon35.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-15"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon36.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-16"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon37.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-17"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon38.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-18"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon39.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-19"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon40.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-20"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon41.jpeg"></a>
        </li>

        <li>
          <a id="carousel-selector-21"><img class="img-responsive" src=
          "thumbs/1michaelanthonysimon42.jpeg"></a>
        </li>
      </ul>
    </div>
  </div>
